...
cmake -S . -B build/ci -G Ninja -DCMAKE_TOOLCHAIN_FILE=/opt/nimby-ci/nimby-mingw.cmake -DCMAKE_BUILD_TYPE=Release -DBUILD_TESTING=ON -DNimbyRailsFranceSDK_DIR="$PWD/.ci/sdk/install/lib/cmake/NimbyRailsFranceSDK" -DSFR_LOADER_SOURCE_DIR="$PWD/.ci/sdk"
